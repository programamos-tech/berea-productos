...
export const metadata: Metadata = {
  ...
  /** Favicon: `app/icon.svg` (Berea House teal bh). Admin: `app/admin/icon.tsx`. */
};
        ...
        style={
          {
            ...
            "--admin-profit-dark": ADMIN_PROFIT_DARK,
            "--admin-loss": ADMIN_LOSS,
            "--admin-loss-dark": ADMIN_LOSS_DARK,

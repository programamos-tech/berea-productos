...
export function ReportsAleyaExportButton({
  ...
  return (
    <div ref={wrapRef} className="relative max-w-full">
      ...
      {open ? (
        <div
          className="absolute left-0 right-0 top-[calc(100%+0.35rem)] z-40 w-full overflow-hidden rounded-xl border border-zinc-200 bg-white shadow-[0_16px_48px_-24px_rgba(24,24,27,0.22)] sm:left-auto sm:right-0 sm:w-[min(100vw-1.5rem,16rem)] dark:border-zinc-700 dark:bg-zinc-900"
          role="dialog"
